      ...
      <header className="sticky top-0 z-50 bg-white/90 backdrop-blur-sm border-b border-[#D6E8E3]">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 flex items-center justify-between h-16">
          ...
          <nav className="flex items-center gap-3" aria-label="Ações principais">
            <a
              href="https://www.upwork.com/freelancers/~01c301a2a6ac28dd45"
              target="_blank"
              rel="noopener noreferrer"
              className="hidden sm:flex items-center gap-1.5 px-4 py-2 rounded-xl text-sm font-medium text-[#6B8A82] hover:text-primary transition-colors duration-200"
              aria-label="Contato no Upwork"
            >
